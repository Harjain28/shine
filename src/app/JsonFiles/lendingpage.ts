export const shineLendingPageJSON = {
  ...
  Faqs: {
    FAQs: [
      {
        Question:
          'Why should I use CreditEnable to apply for my Business Loan?',
        Answer:
